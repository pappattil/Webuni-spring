...
public class HrController {
	...
	{
		employees.put(1L, new HrDto(1L, "Öreg József", "Raktárvezető", 400000, LocalDateTime.of(1993,5,1,13,0)));
		employees.put(2L, new HrDto(2L, "Farkas Piroska", "Irodavezető", 400000, LocalDateTime.of(2014,1,01,10,0)));
		employees.put(3L, new HrDto(3L, "Jóska István", "Operátor", 400000, LocalDateTime.of(2019,9,1,10,00)));
		employees.put(4L, new HrDto(4L, "Fiatal Ödön", "Adminisztrátor", 400000, LocalDateTime.of(2021,1,1,10,0)));
